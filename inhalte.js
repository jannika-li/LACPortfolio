      ...
      reflection: `
        ...
        <div class="grid grid-cols-1 gap-4 my-6">
          <figure class="border border-ink/10 rounded-xl overflow-hidden bg-white shadow-sm">
            <img src="https://images.unsplash.com/photo-1500530855697-b586d89ba3ee?w=800&q=80" alt="Kursplanung — der Ausgangshafen" class="reflection-figure-img" onclick="openLightbox('https://images.unsplash.com/photo-1500530855697-b586d89ba3ee?w=800&q=80')">
