  ...
  },
  {
    ...
    detail: {
      reflection: `
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 gap-4 my-6">
          <figure class="border border-ink/10 rounded-xl overflow-hidden bg-white shadow-sm">
            <img src="https://i.postimg.cc/MZYrRQpG/IMG-4796.jpg" alt="" class="w-full h-56 object-cover">
          </figure>
          <figure class="border border-ink/10 rounded-xl overflow-hidden bg-white shadow-sm">
            <img src="https://i.postimg.cc/2jxXvZS3/IMG-4790.jpg" alt="" class="w-full h-56 object-cover">
          </figure>
          <figure class="border border-ink/10 rounded-xl overflow-hidden bg-white shadow-sm">
            <img src="https://i.postimg.cc/xjPFHz18/IMG-4791.jpg" alt="" class="w-full h-56 object-cover">
          </figure>
          <figure class="border border-ink/10 rounded-xl overflow-hidden bg-white shadow-sm">
            <img src="https://i.postimg.cc/DfcYsXwS/IMG-4792.jpg" alt="" class="w-full h-56 object-cover">
          </figure>
        </div>`,
      media: { images: [], video: null, audio: null },
