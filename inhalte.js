      ...
      reflection: `
        ...
        <div class="grid grid-cols-1 gap-4 my-6">
          <figure class="border border-ink/10 rounded-xl overflow-hidden bg-white shadow-sm">
            <img src="https://images.unsplash.com/photo-1500530855697-b586d89ba3ee?w=800&q=80" alt="Kursplanung — der Ausgangshafen" class="w-full h-56 object-cover">
            <figcaption class="text-xs text-slate px-3 py-2 border-t border-ink/10">Kursplanung — der Ausgangshafen</figcaption>
          </figure>
        </div>`,
    ...
    detail: {
      reflection: `
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 gap-4 my-6">
          <figure class="border border-ink/10 rounded-xl overflow-hidden bg-white shadow-sm">
            <img src="images/_DSC9150.jpg" alt="Probe" class="w-full h-56 object-cover">
            <figcaption class="text-xs text-slate px-3 py-2 border-t border-ink/10">Probe</figcaption>
          </figure>
          <figure class="border border-ink/10 rounded-xl overflow-hidden bg-white shadow-sm">
            <img src="https://images.unsplash.com/photo-1531482615713-2afd69097998?w=800&q=80" alt="Whiteboard-Mitschrift aus dem Seminar" class="w-full h-56 object-cover">
  ...
  },
  {
    ...
    detail: {
      reflection: `
        ...
        <div class="grid grid-cols-1 gap-4 my-6">
          <figure class="border border-ink/10 rounded-xl overflow-hidden bg-white shadow-sm">
            <img src="https://i.postimg.cc/Ssw40YHG/IMG-0587.jpg" alt="" class="w-full h-56 object-cover">
          </figure>
        </div>`,
      media: { images: [], video: null, audio: null },
  ...
  },
  {
    ...
    detail: {
      reflection: `
        ...
        <div class="grid grid-cols-1 gap-4 my-6">
          <figure class="border border-ink/10 rounded-xl overflow-hidden bg-white shadow-sm">
            <img src="https://i.postimg.cc/mD04x1K9/IMG-0589.jpg" alt="" class="w-full h-56 object-cover">
          </figure>
        </div>

        <hr class="border-ink/10 my-8">

        <div class="grid grid-cols-1 gap-4 my-6">
          <figure class="border border-ink/10 rounded-xl overflow-hidden bg-white shadow-sm">
            <img src="https://i.postimg.cc/zB9NmH4j/IMG-0588.jpg" alt="" class="w-full h-56 object-cover">
          </figure>
        </div>`,
      media: { images: [], video: null, audio: null },
  ...
  },
  {
    ...
    detail: {
      reflection: `
        ...
        <div class="grid grid-cols-1 gap-4 my-6">
          <figure class="border border-ink/10 rounded-xl overflow-hidden bg-white shadow-sm">
            <img src="https://i.postimg.cc/9Mv23wsY/IMG-0586.jpg" alt="" class="w-full h-56 object-cover">
          </figure>
        </div>`,
      media: { images: [], video: null, audio: null },
  ...
  },
  {
    ...
    detail: {
      reflection: `
        ...
        <p><strong>Jannika's Problem of the Week</strong></p>
        <p>This week, future Jannika came back from an inspiring leadership conference with an idea for a
        brand new project management methodology that she wanted to implement. Excited to improve her
        department's efficiency, her immediate impulse was to schedule a mandatory, two hour training session
        for next Monday and announce that all forty five employees across all her teams must switch to this
        new system immediately. She caught herself, realizing that forcing a massive, sudden operational
        change onto everyone at once would inevitably trigger anxiety, confusion, and heavy user resistance.
        She took a deep breath and tried to remind herself of a similar situation she could learn from her
        sailing experience.</p>

        <p><strong>Getting help from her sailing experience</strong></p>
        <p>She remembered that a fleet sails much farther and safer when each boat is free to explore the best
        route and immediately share what it learns with the rest. Instead of a single, highly risky decision
        forced upon every vessel simultaneously, a series of small, calculated experiments allows the whole
        fleet to discover the safest course together, keeping the impact of a misstep localized and
        manageable. Jannika realized this offers a powerful alternative to how many traditional organizations
        handle change, where new systems are abruptly rolled out to everyone at once, creating disruptive
        breaks and natural resistance. Instead of attempting a massive transformation overnight, new
        processes, tools, or ways of working should first be tested in small groups.</p>

        <p><strong>Taking Action</strong></p>
        <p>After she understands that she benefits from running localized experiments rather than enforcing
        overnight transformations, she wants to try this one little thing tomorrow and keep learning from
        there. Right before she drafts a department wide announcement about a new tool or process, and before
        she pushes a major change onto her entire workforce, she wants to visually remind herself that "the
        fleet learns from a single scout." Tomorrow, instead of rolling out the project management methodology
        to everyone, she will approach just one small, agile project team of three to four people and say:</p>
        <p><em>"Hey team, I want to test a new project framework that could make our lives easier, but I don't
        want to disrupt the whole department with a blind rollout. I want to treat your team as our autonomous
        scout boat. Let's run a two week experiment using this framework on just your current sprint. Your job
        is to break it, find the flaws, and tell me if it's actually useful before we ever think about showing
        it to the rest of the fleet."</em></p>
  ...
  },
  {
    ...
    detail: {
      reflection: `
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 gap-4 my-6">
          <figure class="border border-ink/10 rounded-xl overflow-hidden bg-white shadow-sm">
            <img src="https://i.postimg.cc/MZYrRQpG/IMG-4796.jpg" alt="Option A" class="w-full h-56 object-cover">
            <figcaption class="text-xs text-slate px-3 py-2 border-t border-ink/10">Option A</figcaption>
          </figure>
          <figure class="border border-ink/10 rounded-xl overflow-hidden bg-white shadow-sm">
            <img src="https://i.postimg.cc/2jxXvZS3/IMG-4790.jpg" alt="Option B" class="w-full h-56 object-cover">
            <figcaption class="text-xs text-slate px-3 py-2 border-t border-ink/10">Option B</figcaption>
          </figure>
          <figure class="border border-ink/10 rounded-xl overflow-hidden bg-white shadow-sm">
            <img src="https://i.postimg.cc/xjPFHz18/IMG-4791.jpg" alt="Option C" class="w-full h-56 object-cover">
            <figcaption class="text-xs text-slate px-3 py-2 border-t border-ink/10">Option C</figcaption>
          </figure>
          <figure class="border border-ink/10 rounded-xl overflow-hidden bg-white shadow-sm">
            <img src="https://i.postimg.cc/DfcYsXwS/IMG-4792.jpg" alt="Result of option C" class="w-full h-56 object-cover">
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 gap-4 my-6">
          <figure class="border border-ink/10 rounded-xl overflow-hidden bg-white shadow-sm">
            <img src="https://i.postimg.cc/7PNQ72ZZ/IMG-4793.jpg" alt="A witch deciding what ingredients to put into her potion" class="w-full h-56 object-cover">
          ...
          <figure class="border border-ink/10 rounded-xl overflow-hidden bg-white shadow-sm">
            <img src="https://i.postimg.cc/XNgDFCYJ/IMG-4794.jpg" alt="Only when the witch puts the correct ingredients into the potion a magical solution appears" class="w-full h-56 object-cover">
